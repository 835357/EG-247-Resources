%% Aliasing 2
% aliaseg2 - Illustrate anti-alisaing filters.
%
...
% rates and played back.  Lowpass 'antialias' filtering is done
% prior to decimation to avert aliasing.
%
